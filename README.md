...
```
cd existing_repo
git remote add origin https://scm.atosresearch.eu/ari/ecd_unit/bd4opem/p2ptrading-dapp.git
git branch -M main
...
- [ ] [Set up project integrations](https://scm.atosresearch.eu/ari/ecd_unit/bd4opem/p2ptrading-dapp/-/settings/integrations)
