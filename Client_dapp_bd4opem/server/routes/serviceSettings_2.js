...
router.post('/', async (req, res, next) => {
  ...
  console.log(req.body.business_parameters?.contractedByOrgID)
  console.log(req.body.business_parameters?.contractStart)
  console.log(req.body.business_parameters?.contractEnd)
  console.log(req.body.status)
  console.log(req.body.version)
  console.log(req.body.business_parameters?.contractedByEmail)
